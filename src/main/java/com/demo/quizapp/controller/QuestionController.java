...
public class QuestionController {
	...
	public ResponseEntity<String> updateQuestions(@PathVariable int id, @RequestBody Question question){
		return questionService.updateQuestions(id,question);
	}
	
	@GetMapping("afterupdate/{id}")
	public ResponseEntity<Question> getDeletedQuestion(@PathVariable int id){
		return questionService.getDeletedQuestion(id);
	}
