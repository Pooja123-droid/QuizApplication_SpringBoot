...
public class Question {
	...
	public String toString() {
		return "Question [id=" + id + ", category=" + category + ", difficulty_level=" + difficulty_level
				...
				+ option3 + ", option4=" + option4 + ", rightAnswer=" + rightAnswer + ", getId()=" + getId()
				+ ", getCategory()=" + getCategory() + ", getDifficulty_level()=" + getDifficulty_level()
				+ ", getQuestionTitle()=" + getQuestionTitle() + ", getOption1()=" + getOption1() + ", getOption2()="
				+ getOption2() + ", getOption3()=" + getOption3() + ", getOption4()=" + getOption4()
				+ ", getRightAnswer()=" + getRightAnswer() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
